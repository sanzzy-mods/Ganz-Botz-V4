...
let anu =`
${pickRandom(global.bokep)}
`
     const message = {
            document: { url: thumb },
            jpegThumbnail: await (await fetch(thumb)).buffer(), fileName: '─────〔 𝗕𝗢𝗞𝗘𝗣 〕─────', mimetype: dpdf, fileLength: fsizedoc, pageCount: fpagedoc, giflogo,
            caption: wm,
            footer: anu,
            templateButtons: [
                {
...
handler.help = ['linkbokep']
handler.tags = ['premium']
handler.command = /^(linkbokep)$/i
handler.group = false
handler.limit = true
